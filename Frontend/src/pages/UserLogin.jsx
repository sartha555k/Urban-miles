...
const UserLogin = () => {
  ...
  return (
    <div>
      ...
      <div className="px-7">
        <Link to= '/captain-login' className="bg-gray-500 flex items-center justify-center text-white placeholder:text-base text-lg px-4 py-2 border w-full mt-6 rounded-xl ">
          Sign in as Captain
        </Link>
      </div>
    </div>
