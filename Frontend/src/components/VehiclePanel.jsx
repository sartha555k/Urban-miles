...
function VehiclePanel(props) {
  return (
    <div>
      ...
      <div onClick={()=>{props.setConfirmRide(true)}} className="flex border border-black rounded-2xl items-center justify-between w-full p-3 mb-2">
        <img
          className="h-10"
      ...
      <div onClick={()=>{props.setConfirmRide(true)}} className="flex border border-black rounded-2xl items-center justify-between w-full p-3 mb-2">
        ...
        />
        <div className=" w-1/2">
          <h4 className="font-medium text-sm">Auto</h4>
          <h5 className="font-medium text-sm">2min away</h5>
          <p className="font-normal text-sm"> Affordable , compact rides</p>
        </div>
        <h2 className="text-2xl font-semibold">193rs</h2>
      ...
      <div onClick={()=>{props.setConfirmRide(true)}} className="flex border border-black rounded-2xl items-center justify-between w-full p-3 mb-2">
        ...
        />
        <div className=" w-1/2">
          <h4 className="font-medium text-sm">Bike</h4>
          <h5 className="font-medium text-sm">2min away</h5>
          <p className="font-normal text-sm"> Affordable , compact rides</p>
        </div>
        <h2 className="text-2xl font-semibold">193rs</h2>
